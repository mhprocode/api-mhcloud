...
|   |   |-- 20250909065855_init
|   |   |   `-- migration.sql
|   |   |-- 20250909073548_add_users_roles_limits
|   |   |   `-- migration.sql
|   |   |-- 20250909074852_add_user_ban_status
|   |   |   `-- migration.sql
|   |   |-- 20250909080737_add_user_name_phone
|   |   |   `-- migration.sql
|   |   `-- migration_lock.toml
|   `-- schema.prisma
|-- registerAdmin.js
...
|   |-- scrapers
|   |   |-- asahOtakService.js
|   |   |-- daftarKotaScraper.js
|   |   |-- jadwalSholatScraper.js
|   |   |-- quranService.js
|   |   |-- rukunIslamScraper.js
|   |   `-- ytdlService.js
|   `-- views
|       |-- pages
|       |   |-- dashboard.ejs
